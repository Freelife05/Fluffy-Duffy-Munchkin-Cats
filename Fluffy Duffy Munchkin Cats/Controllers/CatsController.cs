...
namespace Fluffy_Duffy_Munchkin_Cats.Controllers
{
    public class CatsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Age,Breed,ImageURL")] Cats cats)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Age,Breed,ImageURL")] Cats cats)
        {
            if (id != cats.ID)
            {
                return NotFound();
